...
- `DeveloperGuide.md` - Implementation patterns and technical notes
- `scratchpad.md` - Planning, status tracking, and lessons learned
- `AssetUpdate.md` - Asset update pipeline and script order
- `RecipeUnlocker.md` - Recipe unlocker tool notes and catalog steps
- `SpellEditor.md` - Spell editor tool notes and update workflow
