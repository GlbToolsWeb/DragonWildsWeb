const TAB_CONFIG = {
  bag: {
    label: "Bag Items",
    selected: "./DWE/UI/Inventory/BagTab_Selected.png",
    normal: "./DWE/UI/Inventory/BagTab_Normal.png",
  },
  rune: {
    label: "Rune Items",
    selected: "./DWE/UI/Inventory/RuneTab_Selected.png",
    normal: "./DWE/UI/Inventory/RuneTab_Normal.png",
  },
  ammo: {
    label: "Ammo Items",
    selected: "./DWE/UI/Inventory/AmmoTab_Selected.png",
    normal: "./DWE/UI/Inventory/AmmoTab_Normal.png",
  },
  quest: {
    label: "Quest Items",
    selected: "./DWE/UI/Inventory/QuestTab_Selected.png",
    normal: "./DWE/UI/Inventory/QuestTab_Normal.png",
  },
};
...
const LOAD_ICON = "./DWE/UI/Landing/Load_Character.png";
const LOADED_ICON = "./DWE/UI/Landing/Character_Loaded.png";
const STATUS_ICON_UNLOADED = "./DWE/UI/Status/status_unloaded_icon.png";
const STATUS_ICON_LOADED = "./DWE/UI/Status/status_loaded_icon.png";

const PAGE_SIZE = 32;
const DOTS = {
  current: "./DWE/UI/ItemBrowser/Current_Page_Dot.png",
  normal: "./DWE/UI/ItemBrowser/Non_Selected_Page_Dot.png",
};
const TAB_OFFSETS = {
  bag: 8,
  rune: 32,
...
const BAG_CATEGORY_CONFIG = [
  {
    key: "Armour",
    normal: "./DWE/UI/ItemBrowser/BagTabCategories/Armour_Normal.png",
    selected: "./DWE/UI/ItemBrowser/BagTabCategories/Armour_Selected.png",
  },
  {
    key: "Consumables",
    normal: "./DWE/UI/ItemBrowser/BagTabCategories/Consumables_Normal.png",
    selected: "./DWE/UI/ItemBrowser/BagTabCategories/Consumables_Selected.png",
  },
  {
    key: "Materials",
    normal: "./DWE/UI/ItemBrowser/BagTabCategories/Materials_Normal.png",
    selected: "./DWE/UI/ItemBrowser/BagTabCategories/Materials_Selected.png",
  },
  {
    key: "Tools",
    normal: "./DWE/UI/ItemBrowser/BagTabCategories/Tools_Normal.png",
    selected: "./DWE/UI/ItemBrowser/BagTabCategories/Tools_Selected.png",
  },
  {
    key: "Weapons",
...
function setTooltipContent(data) {
  ...
  nameIcon.src = hasPowerLevel
    ? "./DWE/UI/ToolTip/PowerLevel.png"
    : "./DWE/UI/ToolTip/no_power_level.png";
  nameIcon.alt = "";
  ...
  if (typeof data.weight !== "undefined") {
    rows.push({
      icon: "./DWE/UI/ToolTip/Weight.png",
      value: data.weight,
      showIconText: false,
    });
  }
  if (
    ...
    rows.push({
      icon: "./DWE/UI/ToolTip/Durability.png",
  ...
  if (typeof data.maxStack !== "undefined") {
    rows.push({
      icon: "./DWE/UI/ToolTip/MaxStacks.png",
      value: data.maxStack,
      showIconText: false,
    });
  }
  rows.forEach((row) => {
    ...
    const iconClass =
      row.icon === "./DWE/UI/ToolTip/Durability.png"
...
function buildExportData() {
  ...
  clone.Inventory = buildInventorySection(state.inventory, clone.Inventory, SLOT_LIMITS.inventory);
